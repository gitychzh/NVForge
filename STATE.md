...
## 当前轮基线 (2026-08-02 07:55 CST, R-nvonly-post132 NOP 巡检轮)
- 主仓 git HEAD: dd8047b post132 已 push origin main
- **本轮 R-nvonly-post132 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  0 改动, 0 重启.
  hermes 打 dsv4p_nv SR=16.7% (1/6, 5×429/all_tiers_exhausted + 1×200, 周期性 5min 一发) 是 NVCF 侧 dsv4p 限流, 非 cc2 链路 (cc2 走 glm5_2_nv).
  glm5_2_nv 连续 post100-post132 (33 轮) 无 dsv4p 故障扩散.
- round 文件: `~/hm_ps/hermes_improve_self/rounds/R-nvonly-post132_hm2_cc2_nop_patrol.md`
...
周期性 5min 一发 429 (23:30-23:55 UTC), NVCF 侧 dsv4p 限流模式, 非 cc2 链路问题.
...
与 post131 对比: post131 SR=0.0% (0/6), post132 SR=16.7% (1/6) — 略有恢复, 仍 NVCF 侧, 未扩散到 glm5_2_nv.
