# R438 — NOP 巡检轮 (2026-08-03 01:52 CST)

## 摘要
- 0 改动 0 restart. NOP 巡检轮.
- 数据窗口已刷新 (17:10-17:35, 较 R437 注入的 17:05-17:30 滚动 5min), 滚出 1×200@17:05, 滚入 1×429@17:35.
- cc2 (cc4101-primary) 30min 仍 0 req (cc2 session 间歇空闲, 无评估样本).
- dsv4p_nv 全 caller 30min SR=76.5% (13/17), 4×429 all_tiers_exhausted, 与 R268-R437 模式一致.
- 历史波动区间: R420=86.4% → R429=69.2% → R430=63.6% → R431=80.0% → R432=89.5% → R433=R434=R435=R436=R437=85.0% → R438=76.5%.
- nv_tier_attempts 30min 0 行 → 429 在 tier 层前被拒 (空 IP, all_tiers_failed_in_mapped_tier).
- nv_gw Up 11h, cc4101 Up 53min (本轮未重启).

## 链路数据 (本轮实测 30min 窗口 17:10-17:35)
- caller×model×status: hermes|dsv4p_nv|200×13, hermes|dsv4p_nv|429×4
- dsv4p_nv SR=76.5% (13/17)
- 错误分类: all_tiers_exhausted|all_tiers_failed_in_mapped_tier ×4 (avg_dur 2607s)
- cc4101-primary 30min: 0 req
- 时间分布: 17:10(200)/17:11(200×2)/17:15(200)/17:16(200×4)/17:20(200×2)/17:21(200×3+429×1)/17:25(429)/17:30(429)/17:35(429)
- 前段 17:10-17:21 连续 13×200 恢复明确, 后段 17:21/17:25/17:30/17:35 四次 429 (all_tiers_exhausted)
- per-key: key2 13×200 avg 9968ms; 空 key 4×429
- per-egress-IP: 203.10.96.139 13×100% ; 空 IP 4×429
- finish_reason: tool_calls×11, stop×2 (无 zombie)
...
- 错误类型仅 all_tiers_exhausted, 无新增, 模式与 R268-R437 一致 (一百六十余轮一致).
- dsv4p_nv SR 在 63.6%-89.5% 区间波动, 本轮 76.5% 处于区间中低位, 非突破性退化.
- SR 85.0%→76.5% 是窗口滑动效应 (滚出 1×200@17:05, 滚入 1×429@17:35), 非真实退化.
- 4×429=8/h 略高于 5/h 阈值, 但前段连续 13×200 恢复明确, 整体可接受.
...
- docker ps: nv_gw Up 11h, cc4101 Up 53min, nv_gw_stable Up 24h, ms_gw Up 3 days, logs_db Up 3 days.
- 0 restart.
