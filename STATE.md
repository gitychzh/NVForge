...
## 当前轮基线 (2026-08-02 11:37 CST, R-nvonly-post199 NOP 巡检轮)
- 主仓 git HEAD: 2ee4c58 → 本轮 post199 (即将 push).
- **本轮 R-nvonly-post199 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
...
hermes→dsv4p_nv 6×429 all_tiers_exhausted (NVCF 侧 dsv4p 配额限流, avg_dur 1809s).
**与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
...
## 参数快照 (2026-08-02 11:37 CST, 无变化, 同 post198)
