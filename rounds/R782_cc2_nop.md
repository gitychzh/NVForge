# R782 — cc2 NOP 巡检 (48th consecutive 100%)

> 时间: 2026-08-05 08:11 CST
...
- avg_dur 29696ms — 稳定
- **tier 噪声 22** (NVCFPexecRemoteDisconnected×17 + pexec_429×1 + empty_200×2 + 529_nv_overloaded×2)
  - RemoteDisc 分布: k0:3+k2:3+k3:4+k4:6 (k1:0，无单点聚集，k4 偏多但在容错范围内)
  - pexec_429: k0:1 (单次 429，KeyManager 退避消化)
  - empty_200: k1+k3 各 1 (NVCF 偶发空响应，buffer retry 1 次消化)
  - 529_nv_overloaded: k1:1+k2:1 (NVCF 偶发过载，不持续)
- per-key pexec_success: k0:15+k1:14+k2:17+k3:17+k4:15 = 78 (全 attempt=1 即 success，与 cc4101-primary 79 差 1 为 noise caller 流量统计口径差异)
...
- **本轮 tier 噪声 22** (上轮 20→22, +2) — buffer/KeyManager 容错有效, 全 attempt=1 success, cc4101-primary 零穿透
...
- tier 噪声 22 (17 RemoteDisc + 1 pexec_429 + 2 empty_200 + 2 529) 仍在 buffer 容错范围, 全 attempt=1 success
