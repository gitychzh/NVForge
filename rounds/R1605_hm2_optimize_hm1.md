# HM2 Optimize HM1 — Round R1605

## 决策: NOP (同R1604: 所有失败 zombie+504, 参数全 floor/optimal, ms_gw 100% SR)

## 1. 改前数据 (2026-07-16 10:15 CST)

### 容器状态
- nv_gw: Up 2 hours (healthy), restarted 2026-07-16 00:36 UTC
- compose md5: 64e8fc1a (与 R1604 一致, 无变化)
...
Log 证据: dsv4p_nv 504 gateway timeout → k5 504 → all 5 keys failed (1 other=504, 429=0, empty200=0, timeout=0) → NV-CYCLE → NV-ALL-TIERS-FAIL → ms_gw relay TimeoutError 132,529ms (relay_started=True). ms_gw streaming sync defect (R832/R1103), 代码级, 不可配置修复.
...
### 最近 10 条请求
| ts | model | status | ttfb | dur | error | input_chars | output |
|----|-------|--------|------|-----|-------|-------------|--------|
| 02:08 | dsv4p_nv | 502 | 520 | 63,895 | all_tiers_exhausted | 223,497 | 0 |
| 02:03 | glm5_2_nv | 502 | 6,723 | 6,725 | zombie | 224,010 | 12 |
| 02:03 | glm5_2_nv | 200 | 5,228 | 5,229 | — | 223,472 | 75 |
| 01:37 | dsv4p_nv | 502 | 33,518 | 33,519 | zombie | 224,458 | 0 |
| 01:36 | dsv4p_nv | 200 | 45,963 | 45,964 | — | 223,497 | 0 |
| 01:33 | glm5_2_nv | 502 | 5,206 | 5,207 | zombie | 223,995 | 6 |
| 01:33 | glm5_2_nv | 200 | 5,300 | 5,301 | — | 223,472 | 72 |
| 01:06 | dsv4p_nv | 502 | 4,888 | 4,888 | zombie | 224,013 | 0 |
| 01:06 | dsv4p_nv | 200 | 18,477 | 18,479 | — | 223,497 | 0 |
| 01:03 | glm5_2_nv | 502 | 5,215 | 5,217 | zombie | 223,384 | 6 |
...
零配置修改. 所有参数 floor/optimal, 所有失败根因不可配置修复. ms_gw 100% SR 为可靠回退. 与 R1604 完全一致 — 稳定状态, 等待代码级修复.
