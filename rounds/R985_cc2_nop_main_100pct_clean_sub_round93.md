...
| fallback (cc_requests) | 0 次 (123 req 全未 fb) | ✅ |
| tier 瞬态错误 | RemoteDisconnected 13 / Timeout 2 / empty_200 3 (k0-k4 散落) 全被吸收 | ✅ |
| buffer 效果 | 全 attempt=1 success (~4-11s flush), 无 retry/WAIT-/KEYMGR- 噪声 | ✅ |
...
- tier 瞬态错误 (NVCFPexecRemoteDisconnected 13 / NVCFPexecTimeout 2 / empty_200 3) 被多 key
  round-robin + func_health + buffer 完全吸收, 全部 resolve 为 200。no 持久 key 疲劳。
