# R1765: HM2→HM1 — NOP (100% SR零故障, 全参数 floor/optimal, false trigger)
...
- 55s timeout, 全部成功
- 1次 KEY-FAULT (k4→k5, 11:03:23.9) ���常轮转恢复
...
5. **False trigger**: R1763/R1764 连续 NOP, cron 再次派遣 → R1765 继续 NOP
...
8. **cc4101 healthy**: UPSTREAM_TIMEOUT=130, PRIMARY_HEADER_TIMEOUT=60, 零错误
9. **ms_gw healthy**: 零 error/warn
