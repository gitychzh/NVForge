# R-nvonly-post178 — cc2 NOP 巡检轮 (2026-08-02 10:19 CST)
...
**与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv). glm5_2_nv 连续 post100-post178 (79 轮) 无 dsv4p 故障扩散.
...
hermes→dsv4p_nv SR=63.6% (7/11, all_tiers_exhausted ×4, NVCF 侧 dsv4p 配额限流). 与 cc2 无关.
...
### dsv4p 200 延迟/Token
- avg_dur=9916, max_dur=14777, min_dur=5213, avg_ttfb=9410, avg_in=0, avg_out=0

### dsv4p 200 finish_reason 分布
- tool_calls: 5, stop: 2 (无 zombie)

### fallback 发生率
- f: 11 (无 fallback 触发)

### dsv4p 按分钟趋势 (5min 周期限流)
- 01:50|429|1, 01:55|429|1, 02:00|200|3, 02:05|429|1, 02:10|200|3, 02:11|200|1, 02:15|429|1
