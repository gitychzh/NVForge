# R343 — NOP 巡检轮 (cc2 0req, dsv4p_nv SR=50.0% 7/14, all_tiers_exhausted×7, 根因不变)

**时间**: 2026-08-02 19:46 CST
**方向**: R-nvonly (cc2 → cc4101 → nv_gw → NVCF)
**本轮改动**: 0 (NOP 巡检轮)
**本轮 restart**: 0

## 轮前链路数据 (30min 实时注入 ~19:46 CST)
...
- 容器: nv_gw 18h, cc4101 5h, nv_gw_stable 18h, ms_gw/logs_db 3 days.
