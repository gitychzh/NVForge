# R723 (cc2/HM2): NOP 巡检轮

> 2026-08-03 20:19 CST | 上轮 R722
...
- **0 rows** — cc2 本窗口零流量, 无数据不动手 (连续第 8 轮零流量)
...
- k0 13×200, k1 13×200, k2 13×200, k3 13×200, k4 12×200 — 均衡

### per-egress-IP (dsv4p)
- 134.195.101.180×13, 134.195.101.188×13, 134.195.101.194×13, 203.10.96.139×13, 134.195.101.120×12 — 5 US IP 全 100%

### dsv4p 200 延迟/Token
- avg_dur 7348ms, max_dur 32224ms, min_dur 1430ms, ttfb 6842ms, avg_in 2 tok, avg_out 11 tok
- finish_reason: tool_calls×42, stop×15, length×7 (无 zombie)

### tier 错误 (nv_tier_attempts, 全 NVCF 上游配额副作用)
- IntegrateRemoteDisconnected × 3 (k1/k3/k4)
- pexec_conn_RemoteDisconnected × 4 (k2)
- 注: R722 的 pexec_500×1, pexec_success×1 本窗口消失

### fallback
- f × 68 (全非 cc2, hermes 流量)

### buffer/wait/keymanager 日志
- 无 (无 buffer 触发, 链路直接 fallback 到 dsv4p)

### 根因
- glm5_2_nv NVCF 上游八轮趋势 0%→50%→57.1%→57.1%→66.7%→66.7%→66.7%→50.0%, 本轮小样本(4 req)波动下滑, 非 NVCF 新挂
- cc4101 fallback → dsv4p 兜底 100% 稳健
- cc2 本窗口零流量 (连续第 8 轮)
