...
- all_tiers_exhausted avg_dur 12552ms (vs R607 9482ms) 波动, 仍 NVCF 配额型 (全挂时 KeyManager 等冷却到期再 abort), 非 nv_gw tier 故障
- 502 avg_dur 34716ms ×1 = peer-fb-skip 慢速返回 (dsv4p_nv 跳 peer fb), 全挂时 NVCF 侧慢拒绝
- 无新错误类型, 无参数漂移 → 无介入必要
