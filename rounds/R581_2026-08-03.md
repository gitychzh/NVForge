# R581 — NOP 巡检轮 (2026-08-03 10:18 CST)
...
- dsv4p_nv 12 req: 7×200+5×429 = NVCF 配额波动区间 (命中 key 100% 200, 全挂时空 key 429)
- 6h 趋势 (R575 复测, R576-R581 一致模式): SR 波动 20%-55%, 命中可用 key 时 100% 200 → 非 nv_gw tier 故障
