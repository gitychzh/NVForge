...
- dsv4p_nv 30min (hermes caller): 30 req, 26×200 + 2×429 + 2×502 (SR=86.7%)
  ...
  - per-key: k2=26×200 全 first-attempt 命中 (05:26-05:45 一波稳定输出)
  - per-egress-IP: 203.10.96.139 26×200 / 4 fail (单 IP 主力, 健康轮转, 同 R628)
  - finish_reason: tool_calls×23 + stop×3 (健康, 无 zombie)
  - fallback_occurred=f ×30 (hermes caller 直连 nv_gw, cc4101 层无 ms_gw 兜底触发)
  - 200 avg_dur=12740ms (健康, 同 R628 12740ms 完全持平)
- 错误分类 1 类 (非新错误):
...
- 30min nv_tier_attempts: 0 行 (hermes caller 不走 buffer, KeyManager 层 ABORT, 同 R628)
- cc_requests stream_total_deadline 6h: 0 (deadline 链健康, 同 R628)
...
- 24h 反复低频模式 (R626-R628 已 DB 历史查证 10+ 次), 被 cc4101 fallback ms_gw 兜住, 用户侧无感
