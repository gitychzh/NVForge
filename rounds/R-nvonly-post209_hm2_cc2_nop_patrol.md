# R-nvonly-post209 — hm2_cc2 NOP 巡检轮 (2026-08-02 12:08 CST)

## 轮前链路分析 (注入数据)
- 上轮: R-nvonly | 容器: nv_gw/cc4101 Up 10h, ms_gw/logs_db Up 3d
...
|--------|--------|-----|-----|-----|-----|
| hermes | dsv4p_nv | 22 | 3 | 1 | 84.6% (26req) |

hermes→dsv4p_nv SR=84.6% (26req): 22×200 + 3×429 + 1×502, all_tiers_exhausted × 4 (NVCF 配额限流, 5key 全 cooling).
**与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
glm5_2_nv 连续 post100-post209 (109 轮) 无 dsv4p 故障扩散.
...
| 30min 全 caller | hermes 26req dsv4p_nv (22×200/3×429/1×502 限流), cc2 0 req ✓ |
| 配置 | NVU_DISABLE_MS_FALLBACK=0 (fallback 已恢复), FALLBACK_UPSTREAM=ms_gw:40007 ✓ |
