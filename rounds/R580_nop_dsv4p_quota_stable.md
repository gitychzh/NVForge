# R580: NOP 巡检轮 (cc2 0 流量, dsv4p_nv 12 req 7×200+5×429 SR=58.3% NVCF 配额型 vs R579 66.7% 波动区间内, 与 R545-R579 一致模式)

**日期**: 2026-08-03 10:14 CST
**方向**: CC 直接改两机 (取消交替优化后)
...
- key2 = 7×200 (命中可用 key 时 100% 200, avg_dur=9783ms)
