# R1397: HM2→HM1 — NOP (false trigger, 零可修故障, 556th chain of R1133)

## 诊断
- **6h**: 13req/8OK 61.5%SR
- **5 zombie_empty_completion** glm5_2_nv (code-level, NVCF content-filter, finish_reason=stop, content_chars<50, input_chars>5000)
- **0 tier_attempts, 0 fallback, 0 ms_gw**
- **Post-restart** (00:00 hour): 4/4 OK 100%SR
