# R-nvonly-post243: hm2_cc2 NOP 巡检轮 (2026-08-02 13:06 CST)

## 本轮判定: NOP 巡检轮 (0 改动, 0 重启)

### 依据
- cc2 (cc4101-primary) 30min: **0 req** (无流量产生, 无数据可判 cc2 SR).
- 链路健康无故障: nv_gw /health ok (5 keys, passthrough, default glm5_2_nv), 全容器 Up 11h+.
- cc2 tier error = 0, cc2 buffer/wait 日志 = 空.
...
per-key: key2 扛 22×200 (单 key 健康, avg_dur 9776ms), key3 1×200, 1×429 来自无 key 映射.
per-egress: 203.10.96.139 扛 22×200 (100% SR), 1×429 来自无 egress.
finish_reason: tool_calls×18, stop×5 (无 zombie).
按分钟趋势: 04:40 1×429 (限流), 04:45-05:06 23×200 (恢复).
**与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv). glm5_2_nv 连续 post100-post243 (140 轮) 无 dsv4p 故障扩散.
