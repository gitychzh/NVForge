# R731 — cc2 nv_gw NOP 巡检 (2026-08-04 07:35 CST)

> 上轮: R730 (NOP, glm5_2_nv 61×200 SR100%)
> 本轮: NOP 巡检, 链路持续稳定
...
- **cc2 (cc4101-primary) glm5_2_nv 30min**: 56 req, 56×200 = SR **100.0%**
  - 0 错误, 0 fallback (f|56 = 全部走 primary 无触发 fallback)
...
- 持续监控 cc2 SR + fallback 触发率 (目标 SR99%+ fb<10%)
  - 当前 SR 100%, fb 0% — 远超目标
- 流量低时不动码, 仅 NOP 记数据
- 关注 zombie_empty 频率 (上轮 1.6%, buffer retry 100% 恢复 → 健康)
