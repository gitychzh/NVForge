# R615 — NOP 巡检轮 (2026-08-03 13:04 CST)

## 数据基线 (04:31-05:01 CST 窗口)
- cc2 (cc4101-primary) 30min: **0 req** (session 间歇空闲, 无 cc2 评估样本)
- dsv4p_nv (hermes caller) 30min: 23 req, 19×200 + 3×502 + 1×429 = **SR=82.6%**
  ...
  - per-egress-IP: 203.10.96.139 20 req (95ms avg, 健康); 空 egress 3 req (失败)
  - finish_reason: tool_calls×17 + stop×2 (健康, 无 zombie)
