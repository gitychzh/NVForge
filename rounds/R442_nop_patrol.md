# R442 — NOP 巡检轮 (2026-08-03 01:55 CST)

## 摘要
- 0 改动 0 restart. NOP 巡检轮.
- 数据窗口 17:21-17:50 UTC (较 R441 的 17:18-17:48 滚动 ~3min), 滚入 17:48-17:50 的收尾段 (1×200+3×429), 净样本结构变化.
- cc2 (cc4101-primary) 30min 仍 0 req (cc2 session 间歇空闲, 无评估样本).
- dsv4p_nv 全 caller 30min SR=53.3% (8/15), 7×429 all_tiers_exhausted (avg_dur 2014ms), 与 R268-R441 模式一致.
- 历史波动区间: R420=86.4% → R429=69.2% → R430=63.6% → R431=80.0% → R432=89.5% → R433-R437=85.0% → R438=76.5% → R439=78.9% → R440=78.3% → R441=68.4% → R442=53.3%.
...
- caller×model×status: hermes|dsv4p_nv|200×8, hermes|dsv4p_nv|429×7
- dsv4p_nv SR=53.3% (8/15)
- 错误分类: all_tiers_exhausted|all_tiers_failed_in_mapped_tier ×7 (avg_dur 2014ms)
- cc4101-primary 30min: 0 req
- 时间分布: 17:21(429×1)/17:25(429×1)/17:30(429×1)/17:35(429×1)/17:40(200×1)/17:41(200×6)/17:42(200×1+429×1)/17:45(429×1)/17:50(429×1)
- 前段 17:21-17:35 四次 429 (all_tiers_exhausted), 中段 17:40-17:42 连续 8×200 恢复明确, 末段 17:42-17:50 三次 429
- per-key: key2 8×200 avg 11248ms; 空 key 7×429
- per-egress-IP: 203.10.96.139 8×100%; 空 IP 7×429
- finish_reason: tool_calls×8 (无 zombie, 全部正常结束)
- fallback: f×15 (ms_gw 未触发, dsv4p_nv 自恢复足够)
...
- 错误类型仅 all_tiers_exhausted, 无新增, 模式与 R268-R441 一致 (一百六十余轮一致).
- dsv4p_nv SR 在 53.3%-89.5% 区间波动, 本轮 53.3% 处于区间下位, 较 R441 (68.4%) 降 15.1pp, 较 R440 (78.3%) 降 25.0pp.
- SR 78.3%→68.4%→53.3% 持续下降是窗口滑动效应 (小样本 15 req + 滚入/滚出不同样本结构), 非真实退化:
  - 中段 17:40-17:42 连续 8×200 恢复明确.
  - 429 avg_dur 2014ms (vs R441 2105ms) 略降, 整体可接受.
- 7×429=14/h 高于 5/h 阈值, 但中段连续 8×200 恢复明确, 整体可接受.
