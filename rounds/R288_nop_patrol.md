# R288 — NOP 巡检轮 (2026-08-02 16:16 CST)

## 基线
- 接 R287. 主仓 main `1250786` (R287 round), 本仓 master `772a4b5` (post287 STATE).
- 注入数据 16:16 CST 30min 窗口, 与 R287 的 16:12 窗口几乎完全重合 (同一 NVCF 配额周期延续, 系统稳态延续).

## 判稳
- **NOP 巡检轮**. cc2 (cc4101-primary) 30min 0 req (session 间歇空闲).
- dsv4p_nv 全 caller SR=53.6% (30/56), 失败 26 全 `all_tiers_exhausted`, **无新错误类型**.
- 错误根因与 R278-R287 完全同源: NVCF function 级配额边界点, buffer 5key 轮转对 function 级 429 是已知盲区 (设计盲区非代码缺陷).
...
|---|---|---|---|---|
| hermes | dsv4p_nv | 200 | 29 | key2, egress 203.10.96.139, avg 10694ms |
| hermes | dsv4p_nv | 429 | 4 | 边界点 |
| hermes | dsv4p_nv | 502 | 2 | cooling 尾巴 |
...
- docker ps: cc4101/nv_gw (Up 2h), nv_gw_stable (Up 14h) 全 Up.
