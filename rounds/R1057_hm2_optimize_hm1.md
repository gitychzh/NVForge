# HM2 Optimize HM1 — Round R1057

**Date**: 2026-07-10 12:20  
...
- **最新 commit author**: `opc2_uname` (HM2) — R1056
- **HM1 本地 git log**: 停在 R821 (236 轮落后)
...
### 2.7 docker logs nv_gw (最近200行)
- 仅 2 次 NV-INTEGRATE-ERR: k2 SSLEOFError (10:03, 10:34), 均自循环到 k3 成功
- 0 NV-TIER-FAIL
- 0 NV-EMPTY-FASTBREAK
- 0 peer-fb fallback
- 0 ms-gw fallback
- 18 NV-INTEGRATE-SUCCESS (all glm5_2_nv, first-attempt except the 2 SSLEOF cycles)

### 2.8 HM1 nv_gw env (关键参数)
```
UPSTREAM_TIMEOUT=66
...
完美状态:
- 6h 100% SR (38/38), 0 错误, 0 nv_tier_attempts
