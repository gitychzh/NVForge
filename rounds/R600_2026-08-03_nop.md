# R600 — NOP 巡检轮 (2026-08-03 12:02 CST)

## 基线 (R600 链路分析注入, 12:02 CST)
- cc2 (cc4101-primary) 30min: 0 req (session 间歇���闲, 无 cc2 评估样本)
- dsv4p_nv 30min: 13 req, 8×200 + 5×429 (SR=61.5%, hermes caller)
  - vs R599 45.5% vs R598 50.0% vs R597 50.0% vs R596 57.1% vs R595 66.7% vs R594 54.5% → 波动区间内一致, 与 R545-R599 同一 NVCF 配额波动模式
