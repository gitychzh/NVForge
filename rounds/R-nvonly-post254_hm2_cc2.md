# R-nvonly-post254 hm2_cc2 — NOP 巡检轮 (2026-08-02 13:30 CST)
...
```
3× all_tiers_exhausted 全是 hermes 打 dsv4p_nv (非 cc2 链路)。
...
- 3× all_tiers_exhausted 全是 hermes 打 dsv4p_nv, 与 cc2 (glm5_2_nv) 无关, 不介入。
