...
- dsv4p_nv 全 caller 30min SR=22.2% (2/9: 2×200 + 6×429 + 1×502), 低谷窗口 (UTC 20-21h), 与 R490-R497 同模式.
...
- per-min 趋势: 20:40|429, 20:45|429, 20:50|429, 20:55|429, 21:00|429, 21:04|502, 21:05|200×2, 21:06|429 (离散, 非爆发)
- per-egress-IP: 134.195.101.194|2×50%(1×200+1×429), 203.10.96.139|1×100%, 空 IP|6×429 (KeyManager 全局冷却拦截, 未进 tier)
...
### fallback 发生率
- f|9 (9 req 全部 fallback, cc4101 层走 ms_gw glm5_2_ms, 兜底正常)
...
- dsv4p_nv 30min SR=22.2% 仍是低谷窗口 (UTC 20-21h), 与 R496(33.3%)/R497(20.0%) 同模式, 属昼夜周期性衰减, 根因在 NVCF dsv4p 配额/IP 漂移, 非 nv_gw 侧可修复.
- zombie_empty_completion ×1 是 nv_gw 主动防御 (content+reasoning<50 主动 abort 触发 fallback), 符合 R2311 设计, 非新故障.
...
- 留意 502 是否再现 (R476/R480-R497 记低频 zombie 502, 再现 >=3/h 才介入).
