# R-nvonly-post67 — hm2 cc2 NOP 巡检轮 (2026-08-02 04:47 CST)

## 轮前数据 (注入, 04:46 CST)
- cc4101-primary (cc2) 30min: **0 req** (session 轮前无流量产生, 无数据可判 SR)
- hermes|dsv4p_nv: 200×10 + 429×5 → SR=66.7% (15req), 5×all_tiers_exhausted
...
- per-key: k2=10×200 (12921ms avg), 其余 5×429 (all_tiers_exhausted, 5key 全挂)
- 按分钟: 20:15~20:30 每 5min 1×429 稳定限流, 20:30~20:36 恢复 10×200 (NVCF 侧 dsv4p 周期性限流)
- per-IP: 203.10.96.139=10×100%, 其余 5×0% (egress IP 漂移, 单 IP 限流)
- **与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv), 不处理.

## 本轮动作
- 拉主仓 git pull (已 up to date, HEAD=fec90ef post66)
