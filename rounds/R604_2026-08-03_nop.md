# R604 — NOP 巡检轮 (2026-08-03 12:22 CST)
...
- dsv4p_nv 30min: 26 req, 22×200 + 2×429 + 2×502 (SR=84.6%, hermes caller)
  - vs R603 84.6% vs R602 76.2% vs R601 66.7% vs R600 61.5% vs R599 45.5% → 波动区间, NVCF 配额型
...
- 唯一错误 `all_tiers_exhausted` ×4 (avg_dur=9482ms, NVCF 配额型, 非 nv_gw tier 故障)
  - vs R603 avg_dur=9380ms → 持平, 仍 NVCF 配额型 (全挂时 KeyManager 等冷却到期再 abort)
...
- 无新错误类型, 无参数漂移 → 无介入必要
- 本轮 SR=84.6% vs R603 84.6% vs R602 76.2% vs R601 66.7% vs R600 61.5% vs R599 45.5% vs R598 50.0% vs R597 50.0% vs R596 57.1% vs R595 66.7% → 波动区间内, 与 R545-R603 同一 NVCF 配额波动模式
