...
> 2026-08-03 20:30 CST | 容器: nv_gw 4h, cc4101 4h, dsv4p_nv40066 4h
...
- **nv_gw 全量 30min** (hermes/openclaw caller, 非 cc2, 轮前分析):
  - dsv4p_nv: 27×200 + 2×502 = SR **93.1%** (27/29) — 兜底链路健康
  - glm5_2_nv: 2×502 = SR **0%** (0/2) — NVCF 上游持续退化 (~10h+), 非 nv_gw 可控
- **错误分类**: all_tiers_exhausted × 4 (无新类型)
- **tier 错误**: 空窗口 (无新 nv_tier_attempts)
- **buffer/wait 日志**: 无触发
- **per-key dsv4p** (轮前分析): k0/k1/k2/k3/k4 各 5-6×200 + 2×502(无 key), 均衡健康
- **per-IP dsv4p**: 5 US IP 全 100% (5-6 req each)
