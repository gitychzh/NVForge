# R595 — NOP 巡检轮 (2026-08-03)

## 链路数据 (30min, 11:36 CST 注入 + 复测确认)
...
- dsv4p_nv 30min: 15 req, 10×200 + 5×429 (SR=66.7%, hermes caller)
  ...
  - 空 key 5×429 (全挂时 NVCF 侧拒绝, avg_dur=2310ms 快速返回, 配额��动区间)
...
- 无新错误类型, 无参数漂移 → 无介入必要
- 本轮 SR=66.7% vs R594 54.5% vs R593 69.2% vs R592 66.7% → 波动区间内, 与 R545-R594 同一 NVCF 配额波动模式
