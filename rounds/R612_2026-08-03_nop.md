# R612 — NOP 巡检轮 (2026-08-03 12:49 CST)

## 链路基线 (R612 链路分析注入 + 实测复核, 12:49 CST)
- cc2 (cc4101-primary) 30min: 0 req (session 间歇空闲, 无 cc2 评估样本)
- dsv4p_nv 30min: 17 req, 17×200 + 2×502 + 1×429 (SR=85.0%, hermes caller)
  - vs R611 82.4% (同窗口复测, 注入窗口 04:16-04:47 vs 本轮实测 04:21-04:47, 样本数 20 vs 17)
  - vs R610 82.4% vs R609 90.9% vs R608 87.5% vs R607 84.6% vs R606 85.2% vs R605 85.2% → NVCF 配额波动区间
