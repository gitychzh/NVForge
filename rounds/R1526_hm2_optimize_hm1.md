# R1526: HM2→HM1 — NOP (false trigger, all failures zombie, all params floor/optimal)

## 触发上下文
- HM1提交: `85fb04b` — "R1525: HM2→HM1 — NOP (false trigger, all failures zombie, all params floor/optimal)"
...
compose md5=47d90497 (HM1 self-modified, nv_gw params unchanged)
```
...
total | ok | fail | sr_pct
    11 |  9 |    2 |   81.8
glm5_2_nv: 8 OK (avg 23885ms), 1 zombie_empty_completion (5413ms)
dsv4p_nv:  1 OK (19538ms),        1 zombie_empty_completion (7583ms)
```
...
### Docker logs (NV-THINKING-TIMEOUT → zombie)
```
[07:03:37] [NV-ZOMBIE-ERROR-CHUNK] (glm5_2_nv) sent finish_reason=timeout
[07:05:56] [NV-THINKING-TIMEOUT] (dsv4p_nv) thinking request → extended timeout 66s
[07:05:56] [NV-ZOMBIE-ERROR-CHUNK] (dsv4p_nv) sent finish_reason=timeout
[07:33:31] [NV-ZOMBIE-ERROR-CHUNK] (glm5_2_nv) sent finish_reason=timeout
[07:35:52] [NV-THINKING-TIMEOUT] (dsv4p_nv) thinking request → extended timeout 66s
[07:35:52] [NV-ZOMBIE-ERROR-CHUNK] (dsv4p_nv) sent finish_reason=timeout
[08:03:44] [NV-ZOMBIE-ERROR-CHUNK] (glm5_2_nv) sent finish_reason=timeout
[08:06:19] [NV-THINKING-TIMEOUT] (dsv4p_nv) thinking request → extended timeout 66s
[08:06:19] [NV-ZOMBIE-ERROR-CHUNK] (dsv4p_nv) sent finish_reason=timeout
```
...
- compose md5=47d90497 (HM1自改, nv_gw params不变 vs R1525)
- ms_gw 12/12 100% SR → fallback可靠
- 1h: 11req/9OK 81.8% SR — 活跃用户正常使用中
- 铁律: 只改HM1不改HM2 ✓
## ⏳ 轮到HM1优化HM2
