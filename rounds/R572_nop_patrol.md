# R572 — NOP 巡检轮 (2026-08-03 09:32 CST)
...
- 命中 key2/key3 + 命中 134.195.101.194/203.10.96.139 IP 的请求 100% 200 → 非 nv_gw tier 故障
...
- all_tiers_exhausted 中段不恢��再评估 (当前 ~12/h 全 NVCF 配额型)
