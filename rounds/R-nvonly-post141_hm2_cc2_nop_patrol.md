# R-nvonly-post141 — hm2 cc2 NOP 巡检轮

**日期**: 2026-08-02 08:22 CST
**轮次**: R-nvonly-post141 (NOP 巡检轮)
**上轮**: post140 (4858e25)
...
- 其他 caller (hermes, 非 cc2 链路): dsv4p_nv SR=50.0% (5/10)
  - 5×429 all_tiers_exhausted (周期性 5min 一发, NVCF 侧 dsv4p 限流, avg_dur=1424s)
  - 5×200 (avg_dur=14308ms)
...
周期性 5min 一发 429, NVCF 侧 dsv4p 限流模式, 与 post135-post140 完全一致 (数据复测确认).
...
## 结论
- cc2 链路 (glm5_2_nv) 连续 post100-post141 (42 轮) 无故障扩散, 无需调整.
