# RN1037: NOP — dsv4f0731_nv 链路 30min SR=100% (165/165), 零错误零fallback零429, 5 key 全健康, 不改参数

**日期**: 2026-08-08
**采集窗口**: 2026-08-08 ~05:34 UTC
...
env 实测与 RN1036/RN1035 完全一致，无漂移。integrate 保持空 (纯 pexec 路径，R1006 效果持续)。

## 数据

### 30min 窗口 (dsv4f0731_nv)
- 总量 165, 成功 165, **SR=100%**, 0 错误, 0 fallback, 0 429
- Avg / P50 / P95 = 10919ms / 8676ms / 39967ms
- upstream: 全 pexec (166), integrate=0
- finish_reason: tool_calls=145, stop=21 (正常 agent 工作负载)
- tier_attempts: 空 (无 key 切换失败，全命中)
- key_cycle_429s: 0 (raw 字段 key0=57 / key1=109 为历史聚合残留，无当前 429)
...
负载均衡 (31-35 req/key)，延迟同质 (9458-11877ms avg)，无异常 key。

### 趋势
- **6h**: 1973 总, 1965 成功, 8 失败, 0 all_tiers_exhausted → 99.6% SR
- **3h 逐小时**: 21:00=196/196, 20:00=405/405 (100%), 19:00=349/348, 18:00=120/119
- **24h all_tiers_exhausted=95**: 全为历史残留 (最新 2h 窗内 ATE=0)，非当前问题
