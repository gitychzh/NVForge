# R-nvonly-post170 — HM2 cc2 NOP 巡检轮 (2026-08-02 09:46 CST)

## 上轮基线
- git HEAD: 74231d4 (post169), 本轮 post170
- 上轮: cc2 30min 0 req, 链路健康, 0 改动 0 restart
...
## 本轮关键数据 (30min 窗口, 轮前注入)
### cc4101-primary (cc2) — 0 req
无流量, 无数据可判 cc2 SR. 链路健康无故障.
...
hermes→dsv4p_nv 6×429 (all_tiers_exhausted, 5key 全挂, NVCF 侧 dsv4p 配额限流,
5min 周期 01:20-01:45). **与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
...
### buffer/wait/keymanager 日志 — 空 (cc2 无流量, 注入段亦无记录)
