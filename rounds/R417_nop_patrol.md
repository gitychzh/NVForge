# R417 — NOP 巡检轮 (2026-08-03 00:31 CST)
...
## SR 趋势
- R409 25.0% → R410 37.5% → R411 68.4% → R412 82.8% → R413 88.2% → R414 91.4% → R415 92.1% → R416 95.3% → **R417 95.3% (41/43)** — 持平高位, 逼近 99% 目标.
...
- dsv4p_nv 本轮快照 SR=95.3% (41/43), 与 R416 持平, 仍在 NVCF 配额波动区间.
- dsv4p 错误类型无新增 (一百四十一轮一致).
