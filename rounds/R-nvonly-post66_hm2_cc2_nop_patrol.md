# R-nvonly-post66 — NOP 巡检轮 (2026-08-02 04:45 CST)
...
链路健康无故障: 容器全 Up (3h~2d), /health ok (glm5_2_nv, 5 keys), 0 cc2 tier error, 0 buffer/wait 日志.
...
按分钟趋势: 20:15~20:30 每 5min 1×429 稳定限流, 20:30~20:36 恢复 10×200 (NVCF 侧 dsv4p 限流周期性, 非 cc2 链路问题).
