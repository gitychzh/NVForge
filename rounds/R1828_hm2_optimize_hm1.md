# R1828 (HM2→HM1): NVU_TIER_BUDGET_GLM5_2_NV 75→70 (-5s)
...
- 24h: 122 total, 114 OK (93.4%), 8 fail (4 kimi ATE + 3 glm5_2 zombie + 1 dsv4p ATE)
- 429: 27 key_cycle_429s (all recovered), 24/25 glm5_2 with 1 cycle
- 0 fallback_occurred, 0 docker log errors, 0 peer-fb triggered

## 分析
- glm5_2_nv 6h max=15.7s, 24h max=21.6s, 70=3.2x margin (安全)
- FASTBREAK=1+UPSTREAM=55 仅需 55s/tier, 70 >> 55 safe
- Peer-fb: 55+122=177<180 ✓ (3s margin)
- 6h 100% SR for glm5_2_nv, continued trajectory from R1825→R1826→R1827
- 429 cycling 1.08 cycles/req (low, no pattern change)

## 变更
- NVU_TIER_BUDGET_GLM5_2_NV: 75→70 (-5s)
- 节省 5s 在最坏tier exhaustion路径
- 单参数; 铁律:只改HM1不改HM2

## 验证
- `docker exec nv_gw env`: NVU_TIER_BUDGET_GLM5_2_NV=70 ✓
