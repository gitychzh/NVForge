# HM2 Optimize HM1 — Round R1327

## 触发分析

- 脚本检测到 R1326 自提交 (HM2→HM1 NOP, "这是我提交的, 不触发")
- cron 仍被派遣 — 误触发 (double-dispatch, 41st consecutive post-R1286)
...
### 日志信号
- NV-ZOMBIE-EMPTY: 4 occurrences in tail 100 (09:33, 11:03, 11:33, 12:33, 13:03)
- NV-ZOMBIE-ERROR-CHUNK: zombie detection + error SSE chunk correctly sent
- NV-REQ: all glm5_2_nv integrate, tier_chain=['glm5_2_nv'] (no fallback, 3model) — expected (FALLBACK_GRAPH={})
- 0 NV-TIER-FAIL, 0 NV-CYCLE, 0 NV-FALLBACK, 0 NV-PEER-FB
...
- Compose md5: 6e1b58bc70eca49e500e3034b08376d9 (stable, unchanged from R1323-R1326)
...
### 原因
1. **数据与 R1324-R1326 高度一致**: 54req/47OK/87.0%SR (R1326: 54/47/87.0%, R1325: 54/47/87.0%, R1324: 55/49/89.1%), 7 zombie (R1326: 7, R1325: 7, R1324: 6), 0 tier_attempts, 0 ATE, 0 fallback, ms_gw 13/13
