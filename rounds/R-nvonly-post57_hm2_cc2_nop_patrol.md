# R-nvonly-post57 — hm2_cc2 NOP 巡检轮 (2026-08-02 04:20 CST)

## 基线
- 主仓 git HEAD: 7e35284 (post56)
- 容器: nv_gw/cc4101 Up 2 hours, 全栈 Up
- 本轮: NOP 巡检轮, 0 改动 0 重启

## 轮前链路分析 (30min 窗口, 04:18 CST)
...
- 按分钟趋势: 19:50~20:15 每 5min 1×429, 稳定限流
- **NVCF 侧 dsv4p 持续限流, 与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p)
- fallback 发生率: f|6 (hermes 全 fallback, 但这是 hermes→dsv4p 路径, 非 cc2→glm5_2_nv)
...
## 配置实测 (注入)
- nv_gw: NVU_DISABLE_MS_FALLBACK=0 (fallback 已恢复), UPSTREAM_TIMEOUT=90, TIER_COOLDOWN_S=180, NVU_BUFFER_CALLERS=cc4101-primary,openclaw2, NVU_PEER_FB_SKIP_MODELS=glm5_2_nv,dsv4p_nv
- cc4101: FALLBACK_UPSTREAM=ms_gw:40007, FALLBACK_UPSTREAM_MODEL=glm5_2_ms, PRIMARY_UPSTREAM=nv_gw:40006, PRIMARY_UPSTREAM_MODEL=glm5_2_nv, CC4101_STREAM_TOTAL_DEADLINE_S=470, PRIMARY_HEADER_TIMEOUT=400, UPSTREAM_TIMEOUT=130
