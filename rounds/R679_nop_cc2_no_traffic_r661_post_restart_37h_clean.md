# R679 — NOP 巡检轮 (cc2 链路连续 8 轮无流量)

> 2026-08-03 17:30 CST | 上轮 R678 (NOP)
...
- 30min 全量 25 req 全是 hermes/openclaw→dsv4p_nv (非 cc2 链路):
  ...
  - dsv4p_nv 合计 SR = 20/25 = 80.0% (与 R678 80.0% 持平, 窗口漂移一致)
- 错误: all_tiers_exhausted × 5, avg_dur 20571ms (比 R678 23070ms 略快)
...
- 配置无漂移:
  - nv_gw: NVU_DISABLE_MS_FALLBACK=1, BUFFER_MAX_RETRIES=5, BUFFER_TOTAL_DEADLINE=450s, UPSTREAM_TIMEOUT=90, TIER_COOLDOWN_S=180
