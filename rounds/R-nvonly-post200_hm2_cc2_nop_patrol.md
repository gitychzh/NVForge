# R-nvonly-post200 — hm2 cc2 NOP patrol (2026-08-02)
...
- 全 caller 30min:
  - hermes→dsv4p_nv: 6×429 all_tiers_exhausted (NVCF 侧 dsv4p 配额限流, avg_dur ~2160s 跨度, 按分钟趋势 03:15-03:40 每 5min 1×429)
  - openclaw→dsv4p_nv: 本轮注入数据未见
