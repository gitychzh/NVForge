# R1793 (HM2→HM1): NOP — 零dsv4p_nv post-deploy流量, 改前必有数据铁律触发

## 数据收集 (HM1: 100.109.153.83)

### 6h DB (nv_requests)
- 总: 32 req, 31 OK (96.9% SR), 1 ATE
- glm5_2_nv: 24/24 (100% SR), avg 9214ms — healthy
- dsv4p_nv: 8 req, 7 OK (87.5% SR), avg 45958ms
...
- 零 peer-fb 触发 (docker logs 无 peer-fb 记录)

### glm5_2_nv
- 24/24 (100% SR), avg 9214ms
...
R1790 将 TIER_TIMEOUT_BUDGET_S 175→180 以启用 dsv4p_nv peer-fb (55+122=177<180, 3s margin)。R1791/R1792 均为 NOP — 零 dsv4p_nv post-deploy 流量。本轮同样: 最近一次 dsv4p_nv 请求在 09:31 UTC (11h 前), 即 R1790 重启前。所有 8 条 dsv4p_nv 请求均为 pre-R1790 数据, 无法验证 peer-fb 是否生效。
