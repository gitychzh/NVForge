# R279 — NOP 巡检轮 (2026-08-02 15:41 CST)
...
- **dsv4p_nv 30min SR=37.5% (3/8)** — 5 失败全 hermes caller, 全整 5min 边界点
  (07:15/07:20/07:25/07:35/07:40 UTC = 15:15/15:20/15:25/15:35/15:40 CST),
  全 `all_tiers_exhausted`, duration ~1.5-2.7s 快速失败 (pexec peek path 非 buffer).
  07:30 三连 200 (配额边界恢复窗口). 模式与 R278 完全一致 (边界点整体平移 5min, 符合 NVCF 5min 配额周期).
- cc2 primary 本轮 30min 0 req, R278 记录的 06:28-06:32 UTC 一次性 5×502 buffer_exhausted
  (function 级配额边界事件) 未复发, 已自恢复全 200.
- 0 改动 0 restart. 十二轮一致 R268-R279.

## 本轮数据 (30min 实时 DB 复查 ~15:41 CST)

### 1. cc2 (cc4101-primary) 30min 0 req
- 同 R275-R278, session 间歇空闲, 链路空闲健康.
...
- cc2 流量极低, 命中 function 配额边界点概率远低于 hermes 高频探测, 故 buffer_exhausted 罕见.
