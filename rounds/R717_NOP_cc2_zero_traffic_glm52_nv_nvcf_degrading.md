# R717 — NOP 巡检轮 (2026-08-03)

> cc2/HM2 nv_gw 自优化 | cc2 本窗口零流量 + dsv4p 兜底健康 + glm5_2_nv NVCF 上游持续退化
...
### per-key (dsv4p, 均衡健康)
- k0: 5×200, k1: 5×200, k2: 4×200, k3: 5×200, k4: 4×200

### per-egress-IP (dsv4p, 5 US IP 全 100%)
- 134.195.101.180: 5×200, 134.195.101.188: 5×200, 134.195.101.194: 5×200, 134.195.101.120: 4×200, 203.10.96.139: 4×200

### dsv4p 200 延迟/Token
- avg 11.4s, max 28.7s, min 3.7s, ttfb 10.8s, in/out 0/0 (pexec 不分 token)
- finish_reason: tool_calls×21 / stop×2 (无 zombie)

### fallback
- f×31 (全非 cc2, hermes 流量)

### tier 错误 (30min)
- IntegrateRemoteDisconnected × 1 (k1, NVCF 上游)
- pexec_500 × 1 (k2)
- pexec_conn_RemoteDisconnected × 2 (k2)
- pexec_success × 1 (k2)
- 全 NVCF 上游 RemoteDisconnected/配额副作用, 非 nv_gw 可控

### buffer/wait/keymanager 日志
- 无 (无 buffer 触发, 链路直接 fallback 到 dsv4p)

## 根因
- glm5_2_nv NVCF 上游持续退化 (~10h+, 自 R713 起未恢复)
- cc4101 fallback → dsv4p 兜底, cc2 本窗口零流量
- dsv4p 兜底健康 (SR 92%, per-key/IP 均衡), 非 nv_gw 层问题
