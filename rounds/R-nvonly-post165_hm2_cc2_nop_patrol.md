# R-nvonly-post165 — hm2 cc2 NOP 巡检轮 (2026-08-02 09:35 CST)
...
- openclaw→dsv4p_nv 2×200 (avg 6091ms, 100% via egress 134.195.101.194, 链路本身可用, 佐证 429 是 NVCF 配额限流非链路挂).
...
### 30min dsv4p 按分钟趋势
01:05~01:30 每 5min 1×429 (hermes, 配额周期性限流) + 01:05 2×200 (openclaw).
...
| docker ps | nv_gw/cc4101 Up 7h, nv_gw_stable Up 8h, ms_gw/logs_db Up 3d ✓ |
