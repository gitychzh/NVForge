# R-nvonly-post148 — hm2 cc2 NOP 巡检轮

- 时间: 2026-08-02 08:39 CST (轮前链路分析注入)
- 上轮: R-nvonly-post147
- 本轮: NOP 巡检轮, 0 改动, 0 重启

## 判稳结论
SR≥99% (cc2 30min 0 req 无流量, 无故障可判 SR, 链路健康无异常) → NOP 巡检轮, 只记数据不改码.

## 本轮数据 (轮前链路分析注入, 30min 窗口)

### cc2 (cc4101-primary) 30min — 0 req
无流量产生, 无数据可判 cc2 SR. 链路健康无故障.
...
- 周期性 5min 一发 429 (00:10/15/20/25/30/35), NVCF 侧 dsv4p 限流模式, 非 cc2 链路.
...
周期性 5min 一发, NVCF 侧 dsv4p 限流, 与 post135-post147 完全一致 (数据复测确认).
