# R-nvonly-post175 — hm2 cc2 NOP 巡检轮 (2026-08-02 10:09 CST)

## 轮前链路分析
- 上轮: post174 (NOP). 容器 nv_gw/cc4101 Up 8h.
- 配置无变化同 post174: NVU_DISABLE_MS_FALLBACK=0 (fallback 已恢复),
  CC4101_STREAM_TOTAL_DEADLINE_S=470, PRIMARY_HEADER_TIMEOUT=400,
  UPSTREAM_TIMEOUT=130, BUFFER_MAX_RETRIES=5, BUFFER_TIMEOUT_STAIRS=90×5,
  BUFFER_TOTAL_DEADLINE=450s, NVU_BUFFER_CALLERS=cc4101-primary,openclaw2.
...
docker ps 全 Up (nv_gw/cc4101/nv_gw_stable 8h, ms_gw/logs_db 3d),
0 cc2 tier error, 0 cc2 buffer/wait/error 日志.
0 改动, 0 重启.

hermes 打 dsv4p_nv 8req (3×200, 5×429 all_tiers_exhausted, NVCF 侧 dsv4p 配额限流,
5min 周期 01:35-02:00). **与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
...
hermes→dsv4p_nv SR=37.5% (3/8, all_tiers_exhausted ×5, 5key 全挂,
NVCF 侧 dsv4p 配额限流, 5min 周期 01:35-02:00). **与 cc2 无关**.
