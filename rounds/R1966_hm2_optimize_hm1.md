# R1966 (HM2→HM1): ⏸️ NOP — near-zero post-deploy traffic (63min), all params floor/optimal, 5 zombie all NVCF-level

## 数据
- 6h: 40 req, 35 OK (87.5% SR), 5 fail (status=502, zombie_empty_completion, all glm5_2_nv)
- Post-R1961 restart (2026-07-19 18:35:33 UTC): nv_gw Up 63 minutes, near-zero post-deploy traffic
- 30min burst: 2 req, 2 OK (100% SR — tiny sample, statistically meaningless)
- dsv4p_nv: 10 OK, all phantom ATE (avg=31599ms, max=55335ms), 0 genuine OK — NVCF completely dead
- glm5_2_nv: 30 req, 25 OK (83.3%), avg=9423ms, max=26165ms, p50=9039ms, p95=17616ms, p99=24154ms
...
- R1959 BIG_INPUT_COOLDOWN=86400: 4 big_input caught since restart, 3 peer-fb rescued, 1 zombie (NVCF-level)
...
## 容器日志
- docker logs nv_gw --tail 100: 1 zombie event (NV-ZOMBIE-EMPTY glm5_2_nv, input=152998c, content=11c), 4 big_input breaker OPEN events (all peer-fb rescued), no other errors
- Container healthy, StartedAt 2026-07-19T18:35:33Z, Up 63 minutes
...
| NVU_BIG_INPUT_COOLDOWN_S | 86400 | — | R1959: 21600→86400. Working: 4 caught, 3 peer-fb rescued. | **否决**: 刚部署, 需数据验证 |
...
**NOP判定**: 与 R1960/R1961/R1962/R1963/R1965 一致 — 近零 post-deploy 流量 (63min仅4 request) + 5 zombie 全部 NVCF 级 + 24 ATE 全 peer-fb 救援成功 (100%) + 全部参数 floor/optimal。R1959 的 BIG_INPUT_COOLDOWN=86400 初显效果 (4 caught, 3 rescued, 1 zombie) 但数据量太小。任何改动都是无数据支撑的猜测。
...
## 验证
- ✅ docker ps → nv_gw Up 63 minutes (healthy)
- ✅ docker exec nv_gw env → all params confirmed (no drift)
- ✅ docker logs nv_gw --tail 100 → 1 zombie event, 4 big_input breaker OPEN (all peer-fb rescued), no other error/warn
- ✅ DB 6h: 40/35 OK (87.5% SR), 5 zombie all NVCF-level, 0 config-fixable errors
- ✅ Post-R1961: near-zero traffic, zero config-fixable errors
- ✅ 24 phantom ATE all peer-fb rescued (100% rescue success)
- ✅ Health: {"status": "ok", "proxy_role": "passthrough"}
- ✅ BIG_INPUT breaker: R1959 cooldown=86400 working, 4 caught since restart (3 rescued, 1 zombie NVCF-level)
## ⏳ 轮到HM1优化HM2
