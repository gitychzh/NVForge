...
- dsv4p_nv 全 caller 30min SR=37.5% (3/8: 3×200 + 5×429), 与 R510-R517 同窗口周期性行为 (实测 06:14 CST, 21:35-22:14 UTC).
...
## 链路数据 (06:14 CST 实测, 21:35-22:14 UTC, 同 R510-R517 同窗口周期)
### 30min 窗口 (全 caller, dsv4p_nv)
- 8 req: 3×200 (avg_dur=9568ms, max=17391, min=5583, ttfb=9177, finish=tool_calls×2/stop×1, nv_key_idx=2, egress=203.10.96.139), 5×429 (空 idx, 空 IP, avg_dur=1351ms) → SR=37.5%
- 错误分类: all_tiers_exhausted ×5 (sub=all_tiers_failed_in_mapped_tier, avg_dur=1351ms)
- per-min: 21:35|429, 21:40|200, 21:41|200×5(R514 残留, 前 30min 外), 21:45|429, 21:50|429, 21:55|429, 22:00|429, 22:05|429, 22:10|200, 22:11|200×2 (离散, 22:10 后 200 回升 3 连续成功)
- per-egress-IP: 203.10.96.139|3×100%, 空 IP|5×0
- per-key: nv_key_idx=2 (3×200); 空 idx 5×429
- fallback: f|8 (nv_gw 内 tier 未 fallback; cc4101 层走 ms_gw glm5_2_ms, 链路有保障)
