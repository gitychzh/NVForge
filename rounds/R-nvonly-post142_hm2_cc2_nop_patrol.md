# R-nvonly-post142 — hm2 cc2 NOP 巡检轮

**日期**: 2026-08-02 08:25 CST
**轮次**: R-nvonly-post142 (NOP 巡检轮)
**上轮**: post141 (6c5b666)
...
- 链路健康无故障: 容器全 Up (nv_gw/cc4101/nv_gw_stable 6h, ms_gw/logs_db 2d),
  ...
  0 cc2 tier/buffer/wait/error 日志, 0 stream_total_deadline (6h).
- 其他 caller (hermes, 非 cc2 链路): dsv4p_nv SR=40.0% (4/10)
  - 6×429 all_tiers_exhausted (周期性 5min 一发, NVCF 侧 dsv4p 限流, avg_dur=1554s)
  - 4×200 (avg_dur=15659ms)
...
周期性 5min 一发 429, NVCF 侧 dsv4p 限流模式, 与 post135-post141 完全一致 (数据复测确认).
...
## 结论
- cc2 链路 (glm5_2_nv) 连续 post100-post142 (43 轮) 无故障扩散, 无需调整.
