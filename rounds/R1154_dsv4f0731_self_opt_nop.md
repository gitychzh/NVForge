# R1154: dsv4f0731_nv Self-Opt NOP Round
...
| 总量 / 成功 / 失败 | 167 / 167 / 0 |
| SR% | **100%** |
| Avg / P50 / P95 / Max | 10094ms / 8105ms / 26679ms / 33334ms |
| 错误分类 | (空 — 0 错误) |
| 429 计数 | 0 |
...
key 分布均匀（33–34 请求/key），延迟方差小，无单 key 劣化。

## Upstream type

- `nvcf_pexec`: 167/167 = 100% SR, avg 10094ms
...
- 6h: 1965/1957 success = **99.6% SR** (8 失败)
- 3h 逐小时: 100%, 100%, 99.7%, 99.4%
- 24h all_tiers_exhausted: 97（历史累积，近期无）
...
UPSTREAM_TIMEOUT=50, TIER_COOLDOWN_S=90
