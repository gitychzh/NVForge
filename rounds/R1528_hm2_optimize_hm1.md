# R1528: HM2→HM1 — NOP (post-restart 100% SR, all failures zombie, all params floor/optimal)

## 触发上下文
- HM1提交: `91ffb2e` — "R1527: HM2→HM1 — NOP (post-restart 100% SR, zombie+NameError, all params floor/optimal)"
- 容器重启: 2026-07-16T00:36:30Z (距当前 ~21min)
- DB当前时间: 2026-07-16 00:57 UTC
...
compose md5=64e8fc1a (unchanged from R1527)
```
