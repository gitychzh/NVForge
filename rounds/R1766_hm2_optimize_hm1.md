# R1766: HM2→HM1 — NOP (100% SR零故障, 全参数 floor/optimal, false trigger)
...
唯一1次 pexec_500 在 03:03:20 (tiers_tried=2) — 网关自动重试下一个key成功。
...
| 04:03 | glm5_2_nv | 200 | 9354 | 1 |
| 04:03 | glm5_2_nv | 200 | 6557 | 1 |
...
- ms_gw: ok (7 keys, 10 variants, 0 cooldowns, 0 errors)
...
7. **False trigger**: R1763/R1764/R1765 连续 NOP, cron 再次派遣 → R1766 继续 NOP
