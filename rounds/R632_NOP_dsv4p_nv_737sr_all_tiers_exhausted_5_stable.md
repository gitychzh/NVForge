...
- 错误分类 1 类 (非新错误):
  - `all_tiers_exhausted` ×5 (avg_dur 15050ms: 429→1462ms 快速ABORT; 502→35433ms 长ABORT)
    → R624→R625→R626→R627→R628→R629→R630→R631→R632: 3→3→3→3→3→4→5→5→5 (持平 R630/R631, 仍在 3-5 正常区间)
...
- 本轮 2×502 duration≈35433ms, 同 R626/R627/R628/R629/R630/R631 (34646/35433/35433/35433/35433/35433ms) 模式
...
- dsv4p_nv SR=73.7% 略降 R631 76.2%, 仍在 R617-R631 正常波动区间下沿 (73-91%), 小样本 19req 波动
