# R606 — NOP 巡检轮 (2026-08-03 12:29 CST)

## 链路分析 (注入, 12:29:32 CST)
- 上轮: R605 | nv_gw: Up 22h (was 34h, 容器曾重启) | cc4101: Up 12h (was 22h, 曾重启)
- cc2 (cc4101-primary) 30min: 0 req (session 间歇空闲, 无 cc2 评估样本)
- dsv4p_nv 30min: 27 req, 23×200 + 2×429 + 2×502 (SR=85.2%, hermes caller)
  - vs R605 85.2% vs R604 84.6% vs R603 84.6% vs R602 76.2% vs R601 66.7% vs R600 61.5%
    vs R599 45.5% vs R598 50.0% vs R597 50.0% vs R596 57.1% vs R595 66.7%
    → 波动区间内, 与 R545-R605 同一 NVCF 配额波动模式
