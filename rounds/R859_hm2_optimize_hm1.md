# R859: HM2→HM1 — NOP (37/37 100% 6h SR, zero ATE, zero tier_attempts, peak health sustained, identical to R853–R858)

**Date**: 2026-07-08 13:40 UTC
...
最近请求 (docker logs nv_gw, 13:03–13:33 CST):
...
| 24h OK | 116 (54.7%) |
| 24h ATE | 96 (45.3%) |
| all_tiers_exhausted | 96 (100%) |
| fallback_occurred | 29 (全部 status=200) |

24h 低 SR 全部来自 R845 重启前的 NVCF surge 期 (04:12 UTC 前)。重启后 10/10 OK (100%)。
docker logs 最近 10 条请求全部 NV-SUCCESS first-key。
