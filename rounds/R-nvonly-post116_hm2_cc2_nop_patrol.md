# R-nvonly-post116 — NOP 巡检轮 (2026-08-02 07:10 CST)

## 轮前数据 (注入, 07:10 CST 拉取窗口)
- cc2 (cc4101-primary) 30min: **0 req** (session 轮前无流量产生, 无数据可判 cc2 SR)
- 其他 caller (hermes/openclaw, 非 cc2 链路):
  - hermes|dsv4p_nv: 2×200 + 6×429 (all_tiers_exhausted, avg_dur 1225s)
  - openclaw|dsv4p_nv: 1×200
  - dsv4p_nv SR=33.3% (3/9), 周期性 5min 一发 429
...
dsv4p_nv 33.3% 仍属 NVCF 侧 dsv4p 限流 + hermes/openclaw caller, 与 cc2 (glm5_2_nv) 链路无关, 非本轮职责.
glm5_2_nv 链路连续 post100-post116 (17 轮) 无 dsv4p 故障扩散, 无需调整.
...
| nv_gw env | BUFFER_MAX_RETRIES=5, TIMEOUT_STAIRS=90×5, TOTAL_DEADLINE=450s, UPSTREAM_TIMEOUT=90s ✓ |
