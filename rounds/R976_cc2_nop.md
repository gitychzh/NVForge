# R976 — cc2 NOP 巡检轮 (主链 100% 干净连续第 84 轮)

日期: 2026-08-07 13:27 CST (session fresh start, 无上轮上下文)
容器: nv_gw Up (10h), cc4101 Up (10h)
上轮: R975 (NOP, 主链 106/106 = 100%)

## 结论
**不改码 (NOP)。** cc2 主链路 (cc4101-primary → nv_gw:40006) 30min = **107/107 = 100% SR,
0 bad**, 连续第 **84** 轮 (R893-R976) 100% 干净。坏请求全属 hermes 宿主越界, 非 cc2 范围。

## 数据
- 30min nv_requests caller=cc4101-primary = **107/107 全 200** (dsv4f0731_nv 为首代)。
...
- 模型 SR: dsv4f0731_nv 117/120 = 97.5% (bad 3 条均 hermes + 已知坏 fid)。
- nv_tier_attempts per-key (dsv4p): pexec_success 19~24 (k0-k4) + NVCFPexecRemoteDisconnected
  散落 k0-k4 (~15) + NVCFPexecTimeout k0×1 + empty_200 k3×1 — 全瞬态, 被多 key round-robin +
...
## 验证
- 30min cc4101-primary = 107/107 (live re-pull)。
