# R1181: HM2→HM1 — NOP (false trigger, 49th chain of R1133, zombie-only, all params floor/optimal, NVCF content-filter not config-fixable)
...
- 最新 commit: R1180 (opc2_uname, HM2) — 自提交误触发
- R1181: 二次派遣 (double-dispatch) — R1180 已由预运行脚本提交, symlink 已指向 R1180, 数据相同
- 49th chain of R1133 (R1133→R1181), 全部 NOP + zombie-only
