...
- dsv4p_nv 全 caller 30min SR=22.2% (2/9: 2×200 + 6×429 + 1×502), 与 R499(22.2%)/R498(22.2%) 同低谷窗口一致.
...
- nv_tier_attempts 30min 0 行 (429 在 tier 层前被 KeyManager 全局冷却拦截, 与 R470-R499 一致).
...
- 15:00 → 200×14 / 429×6 → SR=70.0%
- 16:00 → 200×43 / 429×7 / 502×1 → SR=84.3%
- 17:00 → 200×25 / 429×9 → SR=73.5%
- 18:00 → 200×22 / 429×9 / 502×1 → SR=68.8%
- 19:00 → 200×4 / 429×11 → SR=26.7% (低谷起点)
- 20:00 → 200×4 / 429×12 → SR=25.0% (低谷)
- 21:00 → 200×2 / 429×4 / 502×1 → SR=28.6% (低谷)
- 周期性低谷确认: 19-21点 NVCF dsv4p 配额耗尽, 非基础设施侧可修复.
...
- dsv4p_nv 30min SR=22.2% (vs R499 22.2% 持平) 仍是低谷窗口, 属稳态周期性行为, 根因在 NVCF dsv4p 配额/IP 漂移, 非 nv_gw 侧可修复.
