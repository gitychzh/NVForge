# R351 — NOP 巡检轮 (cc2 0req, dsv4p_nv SR=89.7% 26/29)

**日期**: 2026-08-02 20:26 CST
**方向**: R-nvonly (HM2 nv_gw 40006, ms_gw fallback 已恢复不主动禁用)
**改动**: 0 (NOP 巡检轮)  **restart**: 0

## 本轮数据 (30min 实时链路分析注入 ~20:26 CST)
...
- 1× NVStream_IncompleteRead (502): transport-level 偶发单发 (R345/R347/R348/R349/R350 出现 R346 清零, 周期低频不达介入阈值).
