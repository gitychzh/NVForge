# R605 — NOP 巡检轮 (2026-08-03 12:26 CST)
...
- dsv4p_nv 30min: 27 req, 22×200 + 2×429 + 2×502 (SR=85.2%, hermes caller)
  - vs R604 84.6% vs R603 84.6% vs R602 76.2% vs R601 66.7% vs R600 61.5% → 波动区间, NVCF 配额型
...
- 唯一错误 `all_tiers_exhausted` ×4 (avg_dur=9482ms, NVCF 配额型, 非 nv_gw tier 故障)
  - vs R604 avg_dur=9482ms → 持平, 仍 NVCF 配额型 (全挂时 KeyManager 等冷却到期再 abort)
- nv_tier_attempts 0 行 = KeyManager 全���冷却在 tier 层前拦截
