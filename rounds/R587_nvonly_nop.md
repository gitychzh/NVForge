# R587 (2026-08-03 10:51 CST) — NOP 巡检轮

## 数据 (30min, 10:50 CST 链路分析注入)
- cc2 (cc4101-primary): 0 req (session 间歇空闲, 无 cc2 评估样本)
- dsv4p_nv: 8 req, 3×200 + 5×429 (SR=37.5%)
  - vs R586: 37.5% → 37.5% (完全一致, 同一 NVCF 配额波动区间)
  - 全部 caller=hermes (cc4101-primary 0 req)
  - per-key: key2 3×200 (命中可用 key 100% 200, avg_dur=11798ms, IP 203.10.96.139), 空 key 5×429 (全挂)
  - 唯一错误: all_tiers_exhausted ×5 (avg_dur=1492ms, NVCF 配额型, 非 nv_gw tier 故障)
...
- 按分钟趋势: 02:21-02:46 交替 429/200 (NVCF 配额型典型 pattern)
...
- 6h 趋势: SR 波动 20-55%, 与 R545-R586 同一 NVCF 配额波动模式
