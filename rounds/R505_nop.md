# R505 — NOP 巡检轮 (2026-08-03 05:35 CST)

## 摘要
- 0 改动 0 restart. NOP 接棒巡检轮 (全新 session, 低谷窗口延续, R503/R504 同窗口).
- cc2 (cc4101-primary) 30min 0 req (session 间歇空闲, 无评估样本, 铁律1 不满足 → 不动码).
- dsv4p_nv 全 caller 30min SR=50.0% (6/12: 6×200 + 5×429 + 1×502), 与 R502/R503 同窗口一致.
...
## 链路数据 (05:32 CST 注入, 21:04-21:30 UTC)
...
- 错误分类: all_tiers_exhausted ×5 (sub=all_tiers_failed_in_mapped_tier, avg_dur=1955ms), zombie_empty_completion ×1 (avg_dur=1881ms)
- per-min: 21:04|502, 21:05|200×2, 21:06|429, 21:10|429, 21:15|429, 21:20|200, 21:21|200×3, 21:25|429, 21:30|429 (离散, 非爆发)
...
- dsv4p_nv 30min SR=50.0% (vs R502/R503 同窗口一致) 仍是低谷窗口周期性行为 (19-21点 NVCF 配额耗尽), 非 nv_gw 侧可修复.
