# R582 — NOP 巡检轮 (2026-08-03 10:23 CST)
...
- per-key: key2 = 7×200 (命中可用 key 时 100% 200, avg_dur=9783ms, IP 203.10.96.139)
- per-egress-IP: 203.10.96.139 = 7/7 100%, 空 IP = 5/5 0% (全挂时空 IP 429)
...
- 6h 趋势 (R575 复测, R576-R582 一致模式): SR 波动 20%-55%, 命中可用 key 时 100% 200 → 非 nv_gw tier 故障
- KeyManager 行为完全正确: 429 cooldown/count decay/reset 按设计工作
- 无新错误类型, 无参数漂移 → 无介入必要
- 本轮 SR=58.3% vs R581 58.3% vs R580 58.3% vs R579 66.7% → 波动区间内, 与 R545-R581 同一 NVCF 配额波动模式
