# HM2 Optimize HM1 — Round R1157

## 1. 触发分析
- **cron 脚本输出**: "这是我提交的, 不触发" — HM2 自提交 R1156，但 cron 派遣判定 HM1 有新 commit
- HM1 最新 commit: 3357054 (R1156, opc2_uname, HM2 自提交)
- 容器重启: 2026-07-10T19:03:27Z (~7h ago)
- Compose MD5: 7975939c245761e451a8813852dcb9bf (unchanged, same as R1154/R1155/R1156)
...
### 2.2 6h 总体 (20:00-02:00 UTC)
- 45req / 24OK(53.3%) / 21fail
- 全部 glm5_2_nv, 全部 nv_integrate
- avg_dur=5205ms, p95_dur=11817ms
- dsv4p_nv: 0 traffic 6h (但 post-restart 4/4 OK pexec+integrate)
...
- avg_dur=4374ms (失败), max_dur=12569ms
- Gateway 正确检测 → error-chunk → openclaw fallback
- Per-key zombie分布: K0=3, K1=4, K2=3, K3=7, K4=5 (均匀分布)

### 2.5 Hourly 趋势 (glm5_2_nv integrate)
- 20:00: 5/5 OK (100%) avg=4817ms
- 21:00: 9/9 OK (100%) avg=5819ms
- 22:00: 1/9 OK (11.1%) avg=4092ms
- 23:00: 4/9 OK (44.4%) avg=4510ms
- 00:00: 1/7 OK (14.3%) avg=6136ms
- 01:00: 2/4 OK (50.0%) avg=4830ms
- 02:00: 1/2 OK (50.0%) avg=3907ms

### 2.6 Post-restart 全景 (19:03Z→now)
- 53req total: glm5_2_nv 49req(27OK/22zombie) + dsv4p_nv 4req(4OK/0fail)
- dsv4p_nv: 4/4 100% SR (pexec+integrate)
...
### 3.1 原因
1. **全部失败为 zombie_empty_completion** — NVCF content-filter 返回 stop+12chars 对 160K+ 输入。这是 NVCF 层限制，非 proxy 配置可修。
...
8. 这是 R1133 的第 26 条 NOP 链 (zombie-only 模式)。NVCF content-filter 行为不可通过 proxy 配置修复。
