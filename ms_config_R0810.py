...
# R-cc4101-dsv4f-ms: DeepSeek V4 Flash 0731 on ModelScope — 10 typo 变体
# (pattern identical to GLM5_2 / DSV4P: 大小写变体, each carries independent 200/id/day quota)
DSV4F_VARIANT_IDS = [
...
DSV4F_NUM_VARIANTS = int(os.environ.get("DSV4F_NUM_VARIANTS", str(len(DSV4F_VARIANT_IDS))))
DSV4F_VARIANT_IDS = DSV4F_VARIANT_IDS[:DSV4F_NUM_VARIANTS]
...
MODEL_REGISTRY = {
    ...
    # ── R-cc4101-dsv4f-ms: dsv4f_ms for cc4101 fallback ──
    "dsv4f_ms": {
        "backend": "ms_dsv4f",
        "name": "DeepSeek V4 Flash 0731 (ModelScope via ms_gw, 7key×10variant)",
        "variants": DSV4F_VARIANT_IDS,
        "context_window": 131072,
        "max_tokens": 32768,
        "supports_thinking": True,
    },
    # ── R0810: dsv4f0731_ms alias (same backend as dsv4f_ms, explicit 0731 naming) ──
    "dsv4f0731_ms": {
        "backend": "ms_dsv4f",
        "name": "DeepSeek V4 Flash 0731 (ModelScope via ms_gw, 7key×10variant)",
        "variants": DSV4F_VARIANT_IDS,
