...
class BufferStreamSession:
    ...
    def _execute_and_drain(self, timeout_s, is_first=False):
        """
        调 execute_request 获取 NVCF 流（首次复用已有 resp/conn），
        drain 到 buffer，判定。
