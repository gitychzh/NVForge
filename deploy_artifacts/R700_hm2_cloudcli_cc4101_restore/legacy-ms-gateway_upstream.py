...
def call_modelscope(oai_body, variant_id, api_key, display_name, is_stream=False):
    ...
    # R699: strip stream_options — ModelScope GLM-5.2 rejects it (RemoteDisconnected).
    # legacy_cc_2 converters.py adds stream_options:{include_usage:true} for usage tracking,
    # but MS API closes the connection when it sees this field. Strip it here.
