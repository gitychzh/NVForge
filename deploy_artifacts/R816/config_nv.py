...
# R700 (HM2->HM1): dsv4p_nv->glm5_2_nv / glm5_2_nv->dsv4p_nv bidirectional cross-model fallback
# R810: emergency rollback of R753 deletion — FALLBACK_GRAPH is production-required for HM1
FALLBACK_GRAPH = {
    "dsv4p_nv": ["glm5_2_nv"],
    "glm5_2_nv": ["dsv4p_nv"],
    "glm5_1_nv": ["dsv4p_nv"],
