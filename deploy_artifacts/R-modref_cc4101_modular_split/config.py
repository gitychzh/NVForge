...
# R-bugfix5: 默认置空禁用 — FALLBACK_UPSTREAM_URL 已设为 none, 若 FORCE_FALLBACK_MODEL
# 仍为 "cc-glm5-2-ms" 且 zcode 意外发送此 model 名, 会跳过 primary 直走已禁用的 fallback → 失败.
# 纯 glm5.2_nv 架构下不应有任何 force-fallback 路径.
FORCE_FALLBACK_MODEL = os.environ.get("FORCE_FALLBACK_MODEL", "")
