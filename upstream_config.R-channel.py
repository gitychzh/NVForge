...
NVCF_PEXEC_MODELS = {
    ...
    "dsv4f_nv": {
        # R-dsv4f-0731 (2026-08-04): deepseek-v4-flash 0731 function (6166b605, ACTIVE).
        # pexec all-key timeout/400; integrate path 1s 200 OK. Only integrate, pexec as fallback.
        # function_id only used for pexec path (integrate doesn't need it), set to 0731 fid for pexec fallback.
        "function_ids": [os.environ.get("NVCF_DEEPSEEK_FLASH_FUNCTION_ID",
                                        "6166b605-230c-4733-9a95-1fba214c5484")],
    ...
    "glm5_2_nv": {
        ...
        # 实测: b1b22d03 速度适中+大上下文稳定; 3b9748d8 小请求最快但大上下文429多; b6029a96 波动大.
        "function_ids": [os.environ.get("NVCF_GLM52_FUNCTION_ID",
                                        "b1b22d03-1ac7-4204-be9b-84ebb009e1a2"),  # pos0=fid1 首选 mn-tp8-b200
                          os.environ.get("NVCF_GLM52_FUNCTION_ID2",
                                         "3b9748d8-1d85-40e8-8573-0eeaa63a4b63"),  # pos1=fid2 小请求最快
                          os.environ.get("NVCF_GLM52_FUNCTION_ID3",
                                         "b6029a96-0ead-457b-a732-bbfb251486cb")],  # pos2=fid3 波动大
...
# R704: 旧已下架 tier 移除.
NV_MODEL_TIERS = ["kimi_nv", "dsv4p_nv", "dsv4f_nv", "glm5_2_nv"]
