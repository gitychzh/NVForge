...
# ─── dsv4f0731 variants (10, R-adapter-relink) ────────────────────────
# ModelScope model_id: "deepseek-ai/DeepSeek-V4-Flash-0731". 确认可用 (2026-08-05).
# 同 dsv4p_ms 逻辑: 10 个大小写 typo 变体, 各自独立 200/id/day 配额.
# 10 个变体 = 10×7key = 70 槽位, 与 glm5_2_ms/dsv4p_ms 对称.
DSV4F0731_VARIANT_IDS = [
    "deepseek-ai/DeepSeek-V4-Flash-0731",  # v1 (canonical)
    "deepseek-ai/Deepseek-V4-Flash-0731",  # v2
    "deepseek-ai/deepseek-v4-flash-0731",  # v3
    "deepseek-ai/DeepSeek-v4-flash-0731",  # v4
    "deepseek-ai/DEEPSEEK-V4-FLASH-0731",  # v5
    "deepseek-ai/Deepseek-v4-Flash-0731",  # v6
    "deepseek-ai/deepseek-V4-Flash-0731",  # v7
    "deepseek-ai/DeepSeek-V4-flash-0731",  # v8
    "deepseek-ai/deepseek-v4-Flash-0731",  # v9
    "deepseek-ai/DEEPSEEK-v4-flash-0731",  # v10
]
DSV4F0731_NUM_VARIANTS = int(os.environ.get("DSV4F0731_NUM_VARIANTS", str(len(DSV4F0731_VARIANT_IDS))))
DSV4F0731_VARIANT_IDS = DSV4F0731_VARIANT_IDS[:DSV4F0731_NUM_VARIANTS]
...
MODEL_REGISTRY = {
    ...
    # ── R-adapter-relink: dsv4f0731_ms (deepseek-v4-flash-0731 via ModelScope) ──
    "dsv4f0731_ms": {
        "backend": "ms_dsv4f0731",
        "name": "DeepSeek V4 Flash 0731 (ModelScope via ms_gw, 7key×10variant)",
        "variants": DSV4F0731_VARIANT_IDS,
        "context_window": 131072,
        "max_tokens": 32768,
        "supports_thinking": True,
    },
